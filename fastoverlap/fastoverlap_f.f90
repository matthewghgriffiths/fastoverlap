...
SUBROUTINE ALIGN(COORDSB,COORDSA,NATOMS,DEBUG,BOXLX,BOXLY,BOXLZ,TWOD,DISTANCE,DIST2,RIGID,DISPBEST,NDISPS, DISP)
...
INTEGER*8 SAVEPERM(NATOMS), BESTPERM(NATOMS), NDUMMY, PATOMS
