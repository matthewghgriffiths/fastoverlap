...
IF (BULKT) THEN
    DISPBEST = DISPBEST + DISPNEW
    DO J1=1,NATOMS
        DUMMYA(3*(J1-1)+1) = DUMMYA(3*(J1-1)+1) + DISPNEW(1)
        DUMMYA(3*(J1-1)+2) = DUMMYA(3*(J1-1)+2) + DISPNEW(2)
        DUMMYA(3*(J1-1)+3) = DUMMYA(3*(J1-1)+3) + DISPNEW(3)
    ENDDO
ELSE
    RMATBEST = MATMUL(RMATNEW, RMATBEST)
    DO J1=1,NATOMS
        DUMMYA(3*J1-2:3*J1) = MATMUL(RMATNEW, DUMMYA(3*J1-2:3*J1))
    ENDDO
ENDIF
...
SUBROUTINE DEALLOCATEALIGNUTILS()
...
END SUBROUTINE DEALLOCATEALIGNUTILS
