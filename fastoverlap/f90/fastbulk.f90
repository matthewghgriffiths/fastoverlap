...
! SUBROUTINE ALIGN2(COORDSB,COORDSA,NATOMS,DEBUG,NBOXLX,NBOXLY,NBOXLZ,DISTANCE,DIST2,DISPBEST,NDISPS)
...
! DO J=1,FOUNDDISPS
	...
	! ! CALL FINDBESTPERMUTATION(DUMMYB, DUMMYA, NATOMS, BOXLX, BOXLY, BOXLZ, .TRUE., SAVEPERM, CURRDIST, DIST2, WORSTRAD)
...
! SUBROUTINE MEDIANMINPERMDIST(COORDSB,COORDSA,NATOMS,DEBUG,NBOXLX,NBOXLY,NBOXLZ,DISTANCE,DIST2,DISPBEST,DISP)
! ! COORDSA becomes the optimal alignment of the optimal permutation of COORDSB
...
! USE ALIGNUTILS, ONLY : BESTPERM
! USE FASTOVERLAPUTILS, ONLY: FINDBESTPERMUTATION
! ! USE ALIGNUTILS, ONLY: FINDBESTPERMUTATION
! IMPLICIT NONE
...
! ! DOUBLE PRECISION DISP(3), RMAT(3,3)
! DOUBLE PRECISION PERMDIST
...
! ! CALL FINDBESTPERMUTATION(DUMMYB, DUMMYA, NATOMS, .TRUE., BESTPERM, DIST2, DISTANCE)
