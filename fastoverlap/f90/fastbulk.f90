...
USE ALIGNUTILS, ONLY : PERMGROUP, NPERMSIZE, NPERMGROUP, NATOMS, MYUNIT, NSETS, SETS, &
 & BOXLX, BOXLY, BOXLZ, OHCELLT, TWOD, SAVECOORDS, NSTORED
...
USE FASTOVERLAPUTILS, ONLY: FASTLEN, SETNATOMS
IMPLICIT NONE
...
SAVECOORDS = .FALSE. !Don't save coordinates when doing group alignment
CALL SETNATOMS(NATOMS)
...
USE ALIGNUTILS, ONLY: OHOPS, PRINTDISTANCES
USE FASTOVERLAPUTILS, ONLY : SETNATOMS
...
DO J=1,NDISPS
    ...
    IF (TWOD) DISPS(J,3) = 0.D0
    IF (DEBUG.AND.TWOD) WRITE(MYUNIT,'(A)') 'fastoverlap> twod alignment, setting z displacement to 0'
...
USE COMMONS, ONLY : MYUNIT,NFREEZE,GEOMDIFFTOL,ORBITTOL,FREEZE,PULLT,TWOD,  &
    ...
    &   NOINVERSION,GTHOMSONT,MKTRAPT,MULLERBROWNT,RIGID
